# Esta es una libreria externa para comunicarse entre Micro Python y Firebase hecha por el usuario vishal-android-freak en Github: https://github.com/vishal-android-freak/firebase-micropython-esp32/blob/master/ufirebase.py
...
def get_wifi_ssid():
    return "Your SSID here"

def get_wifi_password():
    return "Your password here"

def get_base_de_datos():
    return "https://cripto-project-5f94c-default-rtdb.firebaseio.com/"

def get_centro_de_control():
    return "https://receiving-hashes-default-rtdb.firebaseio.com/"
